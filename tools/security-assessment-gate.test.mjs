...
function manifest(overrides = {}) {
  return JSON.stringify({
    ...
    tools: [
      ...
      { id: "passive-deployment", version: "1.4.0", testIds: ["CSA-DEPLOY-001"] }
    ],
    ...
    toolResults: [
      ...
      { id: "passive-deployment", version: "1.4.0", outcome: "passed" }
    ],
    reason: null,
...
test("given missing or mismatched assessment evidence, when gating it, then it cannot pass", () => {
  ...
  assert.throws(() => assessmentGateRecord(manifest({ catalogVersion: "1.0.0" }), expectations),
    /catalog version differs from the current catalog/);
