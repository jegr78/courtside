...
@Validated
@ConfigurationProperties("courtside.password-reset-mail")
record PasswordResetMailProperties(@Min(1) int maxPerWindow,
    ...
    PasswordResetMailProperties {
        if (window != null && retention != null && retention.compareTo(window) < 0) {
            throw new IllegalStateException("courtside.password-reset-mail.retention (" + retention
