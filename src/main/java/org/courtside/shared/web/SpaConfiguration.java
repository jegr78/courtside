...
class SpaConfiguration implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/account-recovery").setViewName("forward:/index.html");
        ...
        registry.addViewController("/admin/rule-sets").setViewName("forward:/index.html");
        registry.addViewController("/admin/facility").setViewName("forward:/index.html");
        registry.addViewController("/admin/facility/courts").setViewName("forward:/index.html");
        registry.addViewController("/admin/facility/opening-hours").setViewName("forward:/index.html");
        registry.addViewController("/admin/facility/booking-cards").setViewName("forward:/index.html");
        registry.addViewController("/admin/facility/booking-cards/{cardId}")
                .setViewName("forward:/index.html");
        registry.addViewController("/admin/facility/slot-fillers").setViewName("forward:/index.html");
        ...
        registry.addViewController("/admin/export").setViewName("forward:/index.html");
        registry.addViewController("/admin/utilisation").setViewName("forward:/index.html");
        registry.addViewController("/admin/audit").setViewName("forward:/index.html");
        registry.addViewController("/admin/messages").setViewName("forward:/index.html");
        registry.addViewController("/admin/operational-logs").setViewName("forward:/index.html");
    }
}
