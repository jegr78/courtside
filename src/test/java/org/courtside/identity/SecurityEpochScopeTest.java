...
class SecurityEpochScopeTest extends AbstractIntegrationTest {
    ...
    @Test
    void givenASignedInAccount_whenNothingAboutItChanges_thenItsSessionStands() throws Exception {
        // given
