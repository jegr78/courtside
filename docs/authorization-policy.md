...
| `public-club-and-calendar` | `listCourts`, `listOpeningHours`, `getBookingGrid`, `getClubConfig`, `getClubLogo`, `getAppIcon`, `getWebManifest`, `listBookingCardLegend`, `listAllocations` | `ANONYMOUS`, `MEMBER`, `TRAINER`, `SPORT_DIRECTOR`, `YOUTH_DIRECTOR`, `GROUNDSKEEPER`, `TREASURER`, `ADMIN`, `INITIAL_PASSWORD` | `request-boundary`, `public-projection` |
...
Production: `src/main/java/org/courtside/member/RosterService.java#load/1`, `src/main/java/org/courtside/member/RosterService.java#load/2`, `src/main/java/org/courtside/member/RosterService.java#requiredLanguage/1`, `src/main/java/org/courtside/member/web/RosterAdminController.java#toResponse`, `src/main/java/org/courtside/member/internal/RosterSecurityEventLog.java#record`, `src/main/java/org/courtside/config/web/ConfigController.java#toAdminResponse`, `src/main/java/org/courtside/audit/internal/DomainEventWriter.java#actor`, `src/main/java/org/courtside/audit/internal/AuditService.java#matchesBase`, `src/main/java/org/courtside/audit/web/AuditAdminController.java#toResponse`, `src/main/java/org/courtside/notification/web/MessageAdminController.java#toResponse`, `src/main/java/org/courtside/operations/web/OperationalLogAdminController.java#searchOperationalLogs`, `src/main/java/org/courtside/dataexchange/web/SubjectAccessAdminController.java#toResponse`, `src/main/java/org/courtside/dataexchange/web/ExternalReferenceAdminController.java#toResponse`, `src/main/java/org/courtside/dataexchange/web/ImportPreviewAdminController.java#createImportPreview`, `src/main/java/org/courtside/dataexchange/web/ImportPreviewAdminController.java#toResponse`, `src/main/java/org/courtside/dataexchange/web/ImportExecutionAdminController.java#toResponse`, `src/main/java/org/courtside/dataexchange/web/ExportAdminController.java#exportRoster`, `src/main/java/org/courtside/dataexchange/web/ExportAdminController.java#exportBookings`.

Positive tests: `src/test/java/org/courtside/dataexchange/web/SubjectAccessAdminControllerTest.java#givenAPersonTheInstanceHoldsEverythingAbout_whenABoardAsks_thenEachOfThoseThingsIsAnswered`, `src/test/java/org/courtside/operations/OperationalLogAdminControllerTest.java#givenAnAdministratorAndPrivateCriteria_whenSearching_thenTheMatchingPageIsReturned`.

Negative tests: `src/test/java/org/courtside/dataexchange/web/SubjectAccessAdminControllerTest.java#givenABookingSomebodyElseMade_whenABoardAsksAboutTheNamedMember_thenNeitherMakerNorNoteIsNamed`, `src/test/java/org/courtside/operations/OperationalLogAdminControllerTest.java#givenAMemberOrMissingCsrf_whenSearching_thenAccessIsRefused`.
...
| `audit-record-read` | read | `AuditEntry.parameters`, `AuditEntry.subjectId`, `AuditEntry.subjectName`, `AuditEntry.actorAccountId`, `AuditEntry.actorUsername` | `readAuditLog`, `searchAuditLog` | `ADMIN`; `administrator` |
...
| `operational-log-query-write` | write | `OperationalLogSearchRequest.text`, `OperationalLogSearchRequest.traceId` | `searchOperationalLogs` | `ADMIN`; `administrator` |
| `operational-log-record-read` | read | `OperationalLogEntry.message`, `OperationalLogEntry.traceId` | `searchOperationalLogs` | `ADMIN`; `administrator` |
...
| `account-recovery-name` | write | `PasswordResetRequest.username` | `requestPasswordReset` | `ANONYMOUS`, `MEMBER`, `TRAINER`, `SPORT_DIRECTOR`, `YOUTH_DIRECTOR`, `GROUNDSKEEPER`, `TREASURER`, `ADMIN`, `INITIAL_PASSWORD`; `route`, `request-field` |
| `account-recovery-redemption` | never-read | `PasswordResetRedemptionRequest.code`, `PasswordResetRedemptionRequest.password` | `redeemPasswordReset` | `ANONYMOUS`, `MEMBER`, `TRAINER`, `SPORT_DIRECTOR`, `YOUTH_DIRECTOR`, `GROUNDSKEEPER`, `TREASURER`, `ADMIN`, `INITIAL_PASSWORD`; `route`, `request-field` |
| `account-recovery-address` | write | `UsernameReminderRequest.email` | `requestUsernameReminder` | `ANONYMOUS`, `MEMBER`, `TRAINER`, `SPORT_DIRECTOR`, `YOUTH_DIRECTOR`, `GROUNDSKEEPER`, `TREASURER`, `ADMIN`, `INITIAL_PASSWORD`; `route`, `request-field` |
