...
the accessibility suite also runs in WebKit. Keyboard, dialog focus, reflow, reduced-motion and
forced-colour checks complement axe because a scanner cannot decide whether a workflow is usable.
