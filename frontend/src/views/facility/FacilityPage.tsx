...
// A page without children has not loaded yet, so each one states that once, where it builds them.
export function FacilityPage({ testId, title, error, success, children }: FacilityPageProps) {
