...
For Courtside that means this repository: issues, pull requests, code review, discussions and the
commit history. A club that runs its own instance moderates its own members; a report about that
belongs to that club.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately to
the maintainers through GitHub's **Security** tab on this repository, *Report a vulnerability*.
It is the only private channel GitHub offers here, so it carries conduct reports as well as
security ones, and what is sent through it stays visible to the maintainers alone. All complaints
will be reviewed and investigated promptly and fairly.

Behavior that also breaks GitHub's own terms can be reported to GitHub through its
[abuse report form](https://github.com/contact/report-abuse), which can act on an account beyond
this repository.
